<?php 
                            ...
                            $consulta = "SELECT * FROM cuenta_propia WHERE id_cuenta='1'";
                            $ejecutar_consulta = $conexion->query($consulta);
                            $registro_inm = $ejecutar_consulta->fetch_assoc();

                            $saldo = $registro_inm["saldo"];     

                            if ($saldo < 0) {
                                 $deuda = number_format(abs($saldo), 2, ',', '.');
                                 $saldo_ini = "0,00";
                             } 

                            if ($saldo > 0) {
                                 $deuda = "0,00";
                                 $saldo_ini = number_format(abs($saldo), 2, ',', '.');
                             } 
...
<div class="row">
    ...
    <div class="col-md-9 pull-md-right main-content">
        ...
        <iframe name="menu" id="menu" src="registro_inmueble.php" frameborder="0" scrolling="no" onload="resizeIframe('menu','menu');" style="width: 100%;"></iframe>
        ...
        <p style="text-align:center; padding-bottom: 15px !important; ">Creado por <a href="gabrielcaraballo.com.ve" target="_blank">Gabriel Caraballo</a> para <a href="menegrande.com.ve" target="_blank">Conjunto Residencial Mene Grande</a> bajo autorización de la empresa <a href="fantasynetwork.com.ve" target="_blank">Fantasy Network, C.A.</a></p>
    </div><!-- /.main-content -->
    ...
    <div class="col-md-3 pull-md-left sidebar">
        <div menuItemName="Client Contacts" class="panel panel-info">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-folder-o"></i>&nbsp;Últimos cargos
                </h3>
            </div>
            ...
            <div class="list-group">
                <div menuItemName="No Contacts" class="list-group-item" id="Secondary_Sidebar-Client_Contacts-No_Contacts">              
                     ...
                     <iframe name="otro" id="otro" src="secciones/rentas.php" frameborder="0" scrolling="no" onload="resizeIframe('otro','otro');" style="width: 100%;"></iframe>

                    <iframe name="menu" id="menu" src="secciones/registro_renta.php" frameborder="0" scrolling="no" onload="resizeIframe('menu','menu');" style="width: 100%; height: 250px;"></iframe>
                </div>
        ...
        <div menuItemName="Client Shortcuts" class="panel panel-info">
            ...
            <div class="list-group">
                ...
                <a menuItemName="Register New Domain" href="" class="list-group-item" id="Secondary_Sidebar-Client_Shortcuts-Register_New_Domain">
                    <i class="fa fa-globe fa-fw"></i>&nbsp;Registrar una renta mensual
                </a>
