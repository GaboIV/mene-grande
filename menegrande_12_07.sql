...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-07-2016 a las 19:42:49
...
CREATE TABLE IF NOT EXISTS `cuenta_propia` (
...
(3, 'A-01', 'JosÃ© MartÃ­nez', '', '', '', 'a012016', 390, 1, 1),
(4, 'A-02', 'Blanca Lugo', '', '', '', 'BL_022016', 1350, 1, 1),
(5, 'A-03', 'Marilis Clermont', '', '', '', 'A_03_2016', 30, 1, 1),
(6, 'A-04', 'Arelis Rangel', '', '', '', 'AR.A04.16', 150, 1, 1),
(7, 'A-05', 'Carlos RodrÃ­guez', '', '', '', 'CAR_A05', 3890, 1, 1),
(8, 'A-06', 'Ã“scar Ayala', '', '', '', 'oscar_a06', 430, 1, 1),
(9, 'A-07', 'Evanlucy Figueroa', '', '', '', 'EVA2016', -90, 1, 1),
(10, 'A-08', 'Juan PernÃ­a', '', '', '', 'JP_A08_08', 1490, 1, 1),
(11, 'A-09', 'Carlos LÃ³pez', '', '', '', 'CL_A09', 30, 1, 1),
(12, 'A-10', 'Alberto Ramos', '', '', '', 'AR.A10', 1350, 1, 1),
(13, 'A-11', 'Jorge Morillo', '', '', '', 'JM-A11', 390, 1, 1),
(14, 'A-12', 'Alida Vargas', '', '', '', 'Alida_A12', 150, 1, 1),
(15, 'B-01', 'JesÃºs Lugo', '', '', '', 'JL_B01', -90, 1, 1),
(16, 'B-02', 'Jairo RondÃ³n', '', '', '', 'JR.B02', 1810, 1, 1),
(17, 'B-03', 'JosÃ© PÃ©rez', '', '', '', 'JP.B03', -90, 1, 1),
(18, 'B-04', 'Ricardo Reyes', '', '', '', 'rr-b04', 750, 1, 1),
(19, 'B-05', 'Reina de GuillÃ©n', '', '', '', 'RdeG_B05', 390, 1, 1),
(20, 'B-06', 'Daniela Romero', '', '', '', 'DR_B06', 3990, 1, 1),
(21, 'B-07', 'Pedro Aguilera', '', '', '', 'PA.B07', 1350, 1, 1),
(22, 'B-08', 'AlÃ­ Aponte', '', '', '', 'AP-B08', 270, 1, 1),
(23, 'B-09', 'Luis Joel GonzÃ¡lez', '', '', '', 'LJG_B09', 1410, 1, 1),
(24, 'B-10', 'Juan Mendoza', '', '', '', 'JM_B10', 1390, 1, 1),
(25, 'B-11', 'VÃ­ctor Videaux', '', '', '', 'VV_B11', 30, 1, 1),
(26, 'B-12', 'JosÃ© LÃ³pez', '', '', '', 'JL_B-12', 1410, 1, 1),
(28, 'A-22', 'Gabriel E Caraballo M', '', 'gabrielcaraballo1907@gmail.com', '+584262858771', '', -90, 1, 1);
...
(5, 1, 1, '1000', '11/07/2016', '1255858', 20, '11/07/2016 23:05:14', '41caf35', 0),
(6, 4, 1, '1000', '11/07/2016', '145525', 24, '11/07/2016 23:05:42', '8c368c3', 1);
...
INSERT INTO `renta` (`id_renta`, `mes`, `ano`, `monto`, `concepto`, `id_tipo`) VALUES
(18, 8, 2000, '90.00', 'Condominio Agosto-2000', 1);
